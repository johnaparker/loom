...
/// Global configuration stored at ~/.config/loom/config.toml
...
pub struct GlobalConfig {
    ...
    /// Cache directory (default: ~/.cache/loom)
...
pub struct LinearConfig {
    ...
    /// Automatically update Linear issue status on loom new/merge (default: true)
...
/// - `push`: Local-first workflow. After merging to main, auto-push. Before `loom new`, auto-push main if ahead.
...
impl GlobalConfig {
    ...
    /// Prefers ~/.config/loom/config.toml (XDG-style) if it exists,
...
mod tests {
    ...
    fn test_default_config() {
        ...
        assert_eq!(config.cache_dir, "~/.cache/loom");
